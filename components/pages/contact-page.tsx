      ...
      <section className="bg-gradient-to-r from-orange-50 to-blue-50 rounded-xl p-6 md:p-8">
        <div className="text-center space-y-5">
          ...
          <p className="text-slate-600 max-w-xl mx-auto">
            Interested in seeing what we do? Need help with your robot? Contact us to schedule a visit to our shop! We love showing off our robots and sharing our passion for STEM.
          </p>
